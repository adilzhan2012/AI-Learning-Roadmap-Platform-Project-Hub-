/**
 * @file resolveMode.js
 * @description Deterministic keyword & title matching Mode Resolver for mentorContext.
 */
 ...
 */
export function resolveMode(userQuery, currentMode = 'global', currentContextId = null, userProfile = null) {
