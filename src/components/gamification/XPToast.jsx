...
export default function XPToast({ amount, reason }) {
  return (
    <motion.div
      ...
      className="bg-indigo-600 text-white px-4 py-3 rounded-2xl shadow-xl shadow-indigo-500/20 flex items-center gap-3 backdrop-blur-md border border-indigo-400/30"
    >
