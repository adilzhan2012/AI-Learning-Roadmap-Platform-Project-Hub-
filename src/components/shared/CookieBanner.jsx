    ...
    <>
      <div className="fixed bottom-6 left-6 right-6 md:left-auto md:right-8 md:max-w-md z-[200]">
        <motion.div
          ...
          className="bg-surface/95 backdrop-blur-md border border-outline rounded-[20px] p-5 md:p-6 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex flex-col gap-4 text-on-background"
        >
          {/* Header */}
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-on-surface/10 flex items-center justify-center border border-outline-variant">
              <Cookie className="w-5 h-5 text-on-surface" />
            </div>
            ...
            {isRu ? (
              <>
                ...
                <button 
                  ...
                  className="text-on-surface underline font-semibold hover:text-on-surface/80"
                >
