        ...
        <form onSubmit={isLogin ? handleSubmit : (e) => e.preventDefault()} className="space-y-5">
          ...
          {isLogin ? (
            <>
              ...
              <div className="relative">
                <div className="absolute inset-0 z-10 flex items-center justify-center bg-white/30 dark:bg-black/30 backdrop-blur-[2px] rounded-xl">
                  <span className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white px-4 py-2 rounded-lg text-sm font-medium shadow-lg text-center border border-gray-200 dark:border-gray-700 mx-4">
                    {locale === 'ru' ? 'Временно приостановлено на фиксацию ошибок' : 'Temporarily disabled for bug fixing'}
                  </span>
                </div>
