...
export default function Landing() {
  ...
  return (
    <div className="dark min-h-screen bg-background text-on-background font-sans overflow-x-hidden selection:bg-primary-container w-full relative">
              ...
              {isLoggedIn ? (
                <Link to="/dashboard">
                  <motion.button 
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-8 py-4 rounded-full bg-primary text-on-primary font-semibold text-lg shadow-xl flex items-center gap-2"
                  >
      ...
      <section className="relative py-24 px-6 z-10 bg-surface-container-lowest border-t border-outline">
        <div className="max-w-7xl mx-auto flex flex-col gap-24">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <motion.p 
              ...
              className="text-on-surface-variant text-lg md:text-2xl font-light leading-relaxed"
            >
          ...
          <div className="grid md:grid-cols-2 gap-8 w-full">
            {[
              ...
              <motion.div
                ...
                className={`group relative overflow-hidden rounded-[2rem] bg-surface-container backdrop-blur-xl border border-outline-variant p-8 transition-all duration-300 ${feature.borderColor}`}
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <h3 className="text-2xl font-bold text-on-surface mb-4 transition-all">{feature.title}</h3>
                  <p className="text-on-surface-variant text-lg leading-relaxed flex-1">{feature.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="mt-12 text-center">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto w-full">
              <motion.div 
                ...
                className="group bg-surface-container border border-outline-variant rounded-[2rem] p-10 text-left relative overflow-hidden backdrop-blur-xl transition-all duration-500 hover:shadow-[0_0_40px_rgba(59,130,246,0.2)] hover:border-blue-500/40"
              >
                ...
                <div className="flex items-center gap-6 mb-8 relative z-10">
                  ...
                  <div>
                    <h3 className="text-3xl font-bold text-on-surface mb-1">Ивакин Даниил</h3>
                    <p className="text-blue-500 font-mono tracking-widest uppercase text-sm font-semibold">Co-Founder & CEO</p>
                  </div>
                </div>
                <div className="relative z-10">
                  <h4 className="text-on-surface font-semibold text-lg mb-4 flex items-center gap-2">
                    <Sparkles className="w-5 h-5 text-blue-500" /> Выполненная работа:
                  </h4>
                  <ul className="space-y-4 text-on-surface-variant font-light text-[17px]">
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                whileHover={{ scale: 1.03 }}
                className="group bg-surface-container border border-outline-variant rounded-[2rem] p-10 text-left relative overflow-hidden backdrop-blur-xl transition-all duration-500 hover:shadow-[0_0_40px_rgba(168,85,247,0.2)] hover:border-purple-500/40"
              >
                ...
                <div className="flex items-center gap-6 mb-8 relative z-10 sm:flex-row-reverse sm:text-right">
                  ...
                  <div>
                    <h3 className="text-3xl font-bold text-on-surface mb-1">Дутпаев Адильжан</h3>
                    <p className="text-purple-500 font-mono tracking-widest uppercase text-sm font-semibold">Co-Founder & CTO</p>
                  </div>
                </div>
                <div className="relative z-10 sm:text-right">
                  <h4 className="text-on-surface font-semibold text-lg mb-4 flex items-center gap-2 sm:justify-end">
                    Выполненная работа: <Terminal className="w-5 h-5 text-purple-500 hidden sm:block" />
                  </h4>
                  <ul className="space-y-4 text-on-surface-variant font-light text-[17px]">
